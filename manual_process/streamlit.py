...
#Create refrences to the tables
...
annual_wages_cpi_data = annual_wages_cpi_table.to.pandas()

# Streamlit app
st.title("Trends for Customer Price Index and Annual Wages in the USA")
